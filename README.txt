...
ptfe_eg_error calculates the error arising from BRDF, shadow and tilt on 
irradiance determinations with diffuse reflectors.

Copyright (C) 2019  Alexandre Castagna (alexandre.castagna@ugent.be)
...
You should have received a copy of the GNU General Public Licensealong with this 
